...
MEDIA_DELIVERY_SAFE_ROOTS = (
    ...
    # Current cache layout ({HERMES_HOME}/cache/<kind>/) — save_b64_image and
    # friends write here; the legacy *_cache roots above no longer match.
    _HERMES_HOME / "cache" / "images",
    _HERMES_HOME / "cache" / "audio",
    _HERMES_HOME / "cache" / "video",
